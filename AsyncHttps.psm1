...
function Invoke-AsyncHttps
{
    ...
    Write-Host 'This module is configured to:' -ForegroundColor Red -BackgroundColor Black
    Write-Host ' 1) Ignore invalid certificates' -ForegroundColor Red -BackgroundColor Black
    Write-Host " 2) Ignore insecure protocols`n" -ForegroundColor Red -BackgroundColor Black
